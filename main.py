...
background = pygame.image.load(
    r"C:\Users\이윤형\Desktop\python\Spider_beta\game_images\jungle background-pixilart.png"
).convert()
background = pygame.transform.scale(background, (screen_width, screen_height))

# 캐릭터는 클래스로 관리
character_img_path = r"C:\Users\이윤형\Desktop\python\Spider_beta\game_images\gray spider-pixilart.png"
